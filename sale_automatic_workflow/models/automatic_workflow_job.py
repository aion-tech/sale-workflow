...
class AutomaticWorkflowJob(models.Model):
    ...
    @api.model
    def _validate_sale_orders(self, order_filter, sort_by: str):
    ...
    @api.model
    def _create_invoices(self, create_filter, sort_by: str):
        sale_obj = self.env["sale.order"]
    ...
    @api.model
    def _validate_invoices(self, validate_invoice_filter, sort_by: str):
    ...
    @api.model
    def _validate_pickings(self, picking_filter, sort_by: str):
    ...
    @api.model
    def _sale_done(self, sale_done_filter, sort_by: str):
        sale_obj = self.env["sale.order"]
    ...
    @api.model
    def _register_payments(self, payment_filter, sort_by: str):
